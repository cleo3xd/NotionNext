...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Wie wird man seinen Schatten los, 你缺席如同遁迹在这片你莅临的地域',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'A1tism', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一般路过同人女', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.a1tism.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'CS:GO, Valorant, League of Legends', // 网站关键词 英文逗号隔开
